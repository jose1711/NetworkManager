...
NM_GOBJECT_PROPERTIES_DEFINE_NOTIFY (NMSettingTeamPort, obj_properties, NMTeamAttribute, _NM_TEAM_ATTRIBUTE_0);
                                       ...
                                       NMTeamLinkWatcher *link_watcher)
{
	...
	return _maybe_changed (setting,
	                       nm_team_setting_value_link_watchers_add_dup (NM_SETTING_TEAM_PORT_GET_PRIVATE (setting)->team_setting,
	                                                                    link_watcher));
}
